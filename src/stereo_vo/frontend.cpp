...
namespace my_slam
{
    ...
    // @note :  relative_motion_两帧的相对运动，假设匀速运动，给下一帧提供初值
    bool Frontend::Track()
    {
        if (last_frame_)
        {
    ...
    int Frontend::TriangulateNewPoints()
    {
        ...
        spdlog::info("Triangulated {} new points.", cnt_triangulated_pts);
    ...
    int Frontend::EstimateCurrentPose()
    {
        ...
        spdlog::info("Pose estimation: {} inliers, {} outliers.", features.size() - cnt_outlier, cnt_outlier);
    ...
    int Frontend::TrackLastFrame()
    {
        ...
        spdlog::info("Track last frame: {} good points.", num_good_pts);
        return num_good_pts;
    }
    ...
    int Frontend::FindFeaturesInRight()
    {
        ...
        spdlog::info("Find {} points in the right image.", num_good_pts);
        return num_good_pts;
    }
